package local.ims.task1.resource_processor.handlers;

import jakarta.validation.ConstraintViolation;
import jakarta.validation.ConstraintViolationException;
import jakarta.validation.Path;
import jakarta.validation.constraints.Min;
import local.ims.task1.resource_processor.dto.ErrorResponseDto;
import local.ims.task1.resource_processor.exceptions.BaseRequestException;
