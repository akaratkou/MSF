...
/**
 * Spring Boot context for E2E Cucumber tests.
 * Uses MOCK web environment + RestAssuredMockMvc for reliable in-process HTTP testing.
 * All real infrastructure (PostgreSQL, S3, RabbitMQ) is provided via Testcontainers.
 */
